...
# @Author  : dizjia
# @File    : poc_ica_v2.py
# @Description: “内部一致性分析”概念验证实验的第二版。
#               核心修改：将探测针从随机噪声改为了基于随机真实测试集图像的扰动，以进行更精准的探测。
...
config = {
    ...
    "SCHEDULER_PATIENCE": 3,   # 连续3轮 test_loss 不下降就调整
...
if __name__ == "__main__":
    ...
    # 将探测图片传入分析函数
    malicious_score = internal_consistency_analysis(copy.deepcopy(final_global_model_state_dict), malicious_update,
                                                    DEVICE, probe_image_sample)
